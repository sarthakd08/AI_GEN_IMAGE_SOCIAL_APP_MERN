...
function CreatePost() {
  ...
  const generateImage = async () => {
    console.log('## Prompt for ', form.prompt);
    if(form.prompt) {
    ...
    try { 
        ...
        alert('Error coming to FE from route')
      } finally {
        ...
        <form className='mt-16 max-w-5xl' onSubmit={handleSubmit}>
          <div className='flex flex-col justify-center gap-5'> 
            ...
            <FormField
              ...
              type="text"
              name="prompt"
              placeholder="A blue Sky Lit up with stars"
              value={form.prompt}
              handleChange={(e) => handleChange(e, 'prompt')}
              isSurpriseMe
            ...
            <div className="relative bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 w-64 p-3 h-64 flex justify-center items-center">
              { form.photo ? (
                ...
                // />
                <img src="/vite.svg" alt="logo" className='w-40 h-12 object-contain'/>
              )}
